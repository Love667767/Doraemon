...
public class StringUtil {
    ...
    public static String checkNotNull(String str, String defaultStr) {
        return EmptyUtil.isEmpty(str) ? defaultStr : str;
    }
     ...
     */
    public static <T> String format(String mark, T... list) {
    ...
    public static int length(CharSequence s) {
        return checkNotNull(s.toString()).length();
    }
    ...
    public static String upperFirstLetter(String s) {
        if (EmptyUtil.isEmpty(s) || !Character.isLowerCase(s.charAt(0))) {
            return s;
        }
    ...
    public static String lowerFirstLetter(String s) {
        if (EmptyUtil.isEmpty(s) || !Character.isUpperCase(s.charAt(0))) {
            return s;
        }
        return String.valueOf((char) (s.charAt(0) + 32)) + s.substring(1);
    }
