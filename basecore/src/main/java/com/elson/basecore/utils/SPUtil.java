...
public class SPUtil {
    ...
    public static void putAndApply(Context context, String key, Object object) {
        ...
        if (object instanceof String) {
            ...
            editor.putString(key, JsonUtil.toJson(object));
        }
    ...
    public static Object get(Context context, String key, Object defaultObject) {
        ...
        if (defaultObject instanceof String) {
            ...
            return JsonUtil.fromJson(sp.getString(key,""),defaultObject.getClass());
        }
    }
    ...
    public static <T> T getObject(Context context, String key, Class<T> classOfT) {
        SharedPreferences sp = context.getSharedPreferences(getSpName(context), Context.MODE_PRIVATE);
        return JsonUtil.fromJson(sp.getString(key,""),classOfT);
    }
