...
import static com.elson.basecore.utils.common.ConvertUtil.bytes2HexString;
import static com.elson.basecore.utils.common.ConvertUtil.hexString2Bytes;
...
public class EncryptUtil {
    ...
    public static String encryptMD5File2String(String filePath) {
        return encryptMD5File2String(FileUtil.getFileByPath(filePath));
    }
    ...
    public static byte[] encryptMD5File(String filePath) {
        return encryptMD5File(FileUtil.getFileByPath(filePath));
    }
