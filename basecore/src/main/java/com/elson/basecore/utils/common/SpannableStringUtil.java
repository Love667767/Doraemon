...
public class SpannableStringUtil {
    ...
    public static class Builder {
         ...
         * @return {@link Builder}
         */
        public Builder setBitmap(Context context, @NonNull Bitmap bitmap) {
         ...
         * @return {@link Builder}
         */
        public Builder setUri(Context context, @NonNull Uri uri) {
            this.context = context;
            this.uri = uri;
            imageIsUri = true;
            return this;
         ...
         * @return {@link Builder}
         */
        public Builder setResourceId(Context context, @DrawableRes int resourceId) {
            this.context = context;
